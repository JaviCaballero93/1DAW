...
public class MathLearningWithTime {
	...
	public static void main(String[] args) {
		...
		final int NUMBER_OF_DIGITS = 3;
       		...
       		long tiempoTranscurrido = ((finish - start)/1000);
       
       		JOptionPane.showMessageDialog(null, "Ha tardado en realizar 5 respuestas correctas " + tiempoTranscurrido + "s.");
	}
